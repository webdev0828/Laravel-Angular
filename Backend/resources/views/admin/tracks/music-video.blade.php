...
<div class="panel panel-white">
    <div class="panel-body">
        @include('admin.tracks.partials.top-video-modal')
       ...
       <div class="col-md-7 col-sm-12 filter-form">
            ...
            <div class="fix-width">
                ...
                <select class="js-example-responsive form-control music-video-custom-filter select2-size" size="1" multiple="multiple" id="artist_name" tabindex="0">
                </select>
            ...
            <div class="fix-width">
                ...
                <input type="text" class="form-control music-video-custom-filter filter_start_date" id="start_date" name="start_date">    
            </div>

            <div class="fix-width">
                <label>End Date</label>
                <input type="text" class="form-control music-video-custom-filter filter_end_date" id="end_date" name="end_date">
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="video_table" class="display table">
                <thead>
                    <tr>
                        <th>Video</th>
                        <th>Artist</th>
