...
return [
	...
	'app_name' => "Sore Thumb Media",
	'default_user_banners' =>	[
						'frontweb/assets/images/admin/img_page-background.jpg', 
						'frontweb/assets/images/admin/bgd_send-demo.jpg',  
						'frontweb/assets/images/admin/bgd_image.jpg', 
						'frontweb/assets/images/admin/img_track-cover.jpg'
					],
	'default_campaign_backgrounds' =>	[
						'frontweb/assets/images/admin/img_page-background.jpg', 
						'frontweb/assets/images/admin/bgd_send-demo.jpg',  
						'frontweb/assets/images/admin/bgd_image.jpg', 
						'frontweb/assets/images/admin/img_track-cover.jpg'
					],
	'default_dashboard_images' =>	[
						'frontweb/assets/images/page/dashboard/bgd_discover.jpg',
						'frontweb/assets/images/page/dashboard/bgd_music-videos.jpg', 
						'frontweb/assets/images/page/dashboard/bgd_remix-competitions.jpg',  
						'frontweb/assets/images/page/dashboard/bgd_activity-feed.jpg', 
						'frontweb/assets/images/page/dashboard/bgd_stm-news.jpg',
						'frontweb/assets/images/page/dashboard/bgd_coming-soon.jpg'
					],
	'default_profile_image' => 'frontweb/assets/images/admin/empty_profile.jpg',
	'default_news_image' => 'frontweb/assets/images/img_cover-nomask.jpg',
	'default_track_image' => 'frontweb/assets/images/default_coverart.jpg',
	'default_banner_image' => 'frontweb/assets/images/admin/bgd_image.jpg',
	'default_banner_images' => [
						'frontweb/assets/images/admin/discover.png',
						'frontweb/assets/images/admin/music-video.png',
						'frontweb/assets/images/admin/remix-competition.png',
						'frontweb/assets/images/admin/follow-feed.png',
						'frontweb/assets/images/admin/stm-news.png',
					],
	'stm_social_links' => [
						'facebook' 	=> 'http://facebook.com/sorethumbmedia',
						'soundcloud'=> 'http://soundcloud.com/sorethumbmedia',
						'twitter' 	=> 'http://twitter.com/sorethumbmedia',
						'youtube' 	=> 'http://www.youtube.com/channel/UC6yJyQc1PUrIcJpFlmq2NDA',
						/*'youtube' 	=> 'http://youtube.com/sorethumbmedia',*/
						'instagram' => 'http://instagram.com/sorethumbmedia'
