...
(function (root, factory) {
    ...
    function _initializeZoom() {
        var self = this,
            ...
            signMinus = self.elements.signMinus = document.createElement('p'),
            signPlus = self.elements.signPlus = document.createElement('p')
            ;

        addClass(wrap, 'cr-slider-wrap');

        addClass(zoomer, 'cr-slider');
        addClass(zoomer, 'pull-left');

        addClass(signMinus, 'glyphicon');
        addClass(signMinus, 'glyphicon-minus');
        addClass(signMinus, 'pull-left');

        addClass(signPlus, 'glyphicon');
        addClass(signPlus, 'glyphicon-plus');
        addClass(signPlus, 'pull-left');
