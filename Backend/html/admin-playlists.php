                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav">
                      <li><a href="admin-favourites.php">Favourites</a></li>
                      <li class="active"><a href="admin-playlists.php">Playlists</a></li>
                    </ul>
                  </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
              </nav>
                ...
                <div class="col-xs-12">
                  <div class="filter-tags">
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <a href="#" class="red-button pull-right">Add playlist</a>
                      </div><!-- /.col-sm-5 -->
                    </div><!-- /.row -->
                  ...
                  <div class="col-xs-12">
                    <div class="flexbox">
                      ...
                      <div class="circle-plus-wrapper">
                        <a class="circle-plus" href="#">
                          <div class="vertical-center">
                            <i class="fa fa-plus"></i>
                          </div><!-- /.vertical-center -->
                        </a>
                      </div><!-- /.circle-plus-wrapper -->
