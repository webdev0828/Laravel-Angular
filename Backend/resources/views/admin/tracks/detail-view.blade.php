...
<div class="page-breadcrumb">
    <ol class="breadcrumb container">
        ...
        <li><a href="{!! url('/admin/'.$mainTitle) !!}">{!! @ucfirst($mainTitle) !!}</a></li>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-3">
                ...
                <div class="col-sm-6 col-md-12 col-lg-12" align="center"> 
                    ...
                    <div>
                        <img id="previewPhoto" name="image" src="{!! !empty($trackData->background_file) ? asset('/timthumb.php?src='.$trackData->background_file.'&w=500&h=500&q=100') : Config::get('constants.default_track_image') !!}" class="img-thumbnail img-responsive" id="admin_photoPreview" onError="this.onerror=null; this.src='/{!! Config::get('constants.default_track_image') !!}'" alt="User Image">
                    </div>
                    @endif
                    <div class="clearfix">&nbsp;</div>                    
                </div>
                ...
                @if($trackData->status == "approved" && $trackData->type == "discover")
                <div class="col-sm-6 col-md-12 col-lg-12 info-page" align="center">
                    <button class="btn btn-danger btn-block" id="RejectTrack" data-id="{!! $trackData->id !!}">Mark as Rejected</button>
                </div>
                @endif
            </div>
            <div class=" col-md-9 col-lg-9 ">
                <table class="table table-bottom-bordered">
                    <tbody>
                        <tr>
                            <td class="col-md-3"><b>Artist :</b></td>
                            <td class="col-md-9">{!! $trackData->artist->name ? $trackData->artist->name : 'No Artist' !!}</td>
                        </tr>
                        <tr>
                            <td class="col-md-3"><b>Artist Links :</b></td>
                            <td class="col-md-9">
                            @if($artistUrls)
                        ...
                        <tr>
                            <td class="col-md-3"><b>Sub Genres :</b></td>
                            <td class="col-md-9">
                        ...
                        <tr>
                            <td class="col-md-3"><b>Vibes :</b></td>
                            <td class="col-md-9">
                        ...
                        <tr>
                            <td class="col-md-3"><b>Uploaded At :</b></td>
                            <td class="col-md-9">{!! $trackData->created_at->diffForHumans(); !!}</td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <tbody>
                           @foreach($socialData as $key => $value)
                                <tr>
                                    ...
                                    @elseif($trackData->type=='discover' && $key=="facebook")
                                     <td>{!! isset($value->like)? $value->like == 'true' ? '<i class="fa fa-check text-success" aria-hidden="true"></i>': '<i class="fa fa-times text-danger" aria-hidden="true"></i>' : ' ' !!}</td>
                                     @else
                                        <td>&nbsp;</td>
                                    @endif
