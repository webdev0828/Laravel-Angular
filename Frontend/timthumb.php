...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '/home/sorethumbmediaco/public_html/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 244);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 244);							// Default thumbnail height. Allows overrid in timthumb-config.php
